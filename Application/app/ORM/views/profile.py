...
class Profile(Model):
    ...
    column_names = ['id', 'username', 'last_name', 'first_name', 'age', 'profile_image',
                    'bio', 'gender', 'gender_pref', 'fame_rate', 'connected', 'location', 'lng', 'lat', 'last_connection', 'allow_geoloc']


    def __init__(self, id, username, last_name, first_name, age,
                 profile_image, bio, gender, gender_pref, fame_rate, connected, location, lng, lat, last_connection, allow_geoloc):
        self.id = id
